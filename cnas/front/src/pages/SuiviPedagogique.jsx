...
const SuiviPedagogique = () => {
  ...
  const handleChange = (e, field) => {
    ...
    // Restore scroll after re-render to prevent jump-to-top
  ...
  return (
    <Side>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100" style={{ overflowAnchor: 'none' }}>
        {/* Header fixe */}
        <div className="sticky top-0 z-10 bg-white border-b border-gray-200 shadow-md" style={{ overflowAnchor: 'none' }}>
