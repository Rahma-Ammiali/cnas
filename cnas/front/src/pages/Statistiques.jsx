                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-[0_10px_30px_rgba(8,_112,_184,_0.2)]">
                        ...
                        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="p-4 rounded-lg border border-gray-100 bg-gray-50">
                                <div className="text-sm text-[#00428C]/70">Année scolaire</div>
                                <div className="text-xl font-semibold text-[#00428C]">{stats.anneeScolaire}</div>
                            </div>
                            <div className="p-4 rounded-lg border border-gray-100 bg-gray-50">
                                <div className="text-sm text-[#00428C]/70">Enfants sortis (tous)</div>
                                <div className="text-xl font-semibold text-[#00428C]">{stats.nbSortis}</div>
                            </div>
                            <div className="p-4 rounded-lg border border-gray-100 bg-gray-50">
                                <div className="text-sm text-[#00428C]/70">Avec paiement (année en cours)</div>
                                <div className="text-xl font-semibold text-[#00428C]">{stats.nbAvecPaiement}</div>
                            </div>
                            <div className="p-4 rounded-lg border border-gray-100 bg-gray-50">
                                <div className="text-sm text-[#00428C]/70">Sans paiement (année en cours)</div>
                                <div className="text-xl font-semibold text-[#00428C]">{stats.nbSansPaiement}</div>
                            </div>
                        </div>
                    </div>
