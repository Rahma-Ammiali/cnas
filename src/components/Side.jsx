...
const Side = ({children}) => {
    ...
    const Menus = [
        {title : "Acceuil" , icone : <GoHome className='w-6 h-6 text-[#00428C]'/> , path:"/Home"},
        {title : "Tableau de bord" , icone : <PiChartDonut  className='w-6 h-6 text-[#00428C]'/> ,path : "Dashboard"},
        {title : "Nouveau utilisateur" , icone : <CiUser className='w-6 h-6 text-[#00428C]'/> , path:"/Utilisateur"},
        {title : "Quiter" , icone : <IoLogOutOutline className='w-6 h-6 text-[#00428C]'/> , path:"Sign"},
    ]
  return (
    <div className='flex'>
        {/* sidebar */}
        <div
        className={`${open ? 'lg :w-[13vw] md:w-[15vw] sm:w-[25vw]' :'w-[8%]'} p-[1.5%] pt-0 duration-300 h-screen bg-white drop-shadow-xl relative`}
        >
            {/* toggle button  */}
